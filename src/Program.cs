...
app.MapGet("/", () => new CustomHTMLResult($"<html>{bootstrapUrl}<body class=\"{config["Settings:backgroundClass"]}\"><h1>Hello World! from <span>{Environment.MachineName}</span></body></html>"));
